...
class RecordHeader(object):
    ...
    # pack_formats.update({x: '=4sIl3I' for x in {2, 3}}) # TODO i or l ?
    pack_formats.update({x: '=4sIhh3I' for x in {2, 3, 4, 5}}) # Cell Blocks
    ...
    def __init__(self, recType='TES4', size=0, arg1=0, arg2=0, arg3=0, arg4=0):
        ...
        class or better add __slots__ and iterate over them in pack. Monkey
        patched here with __oblivion sentinel - which means you must NEVER
        instantiate an Oblivion header passing in 'extra'. Both issues should
        be fixed at once.
        ...
        :param arg4: For GRUP 2h, form_version, unknown (it's 0 for known mods)
